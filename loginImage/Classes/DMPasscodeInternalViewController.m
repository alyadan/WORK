...
//    self.view.backgroundColor = [UIColor redColor];
    ...
    _instructions.textColor = [UIColor colorWithWhite:0.8 alpha:1.0]; // the color of the "Enter the code"
    ...
    // 输入键盘
    _input = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, 100, 100)];
